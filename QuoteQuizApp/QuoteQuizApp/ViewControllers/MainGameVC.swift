...
class MainGameVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //Default mode when app is launched is "Multiple Questions"
        setQuestion(id: 0, questionsContainer: PlayerScoreAndDataForSession.globalScore.multipleAnswersData)
        //Hide Yes/No game mode visual elements from interface
    ...
    //Prepare view before its loaded
    func prepareViewAndUpdateUI(){
